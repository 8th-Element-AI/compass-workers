...
Faithfulness recipe (identical to quality_observability.pipeline.score_generation):
...
Usage:
    ...
    python eval/benchmark_faithfulness.py --models cross-encoder/nli-deberta-v3-xsmall
"""
...
from quality_observability.constants import PREMISE_MAX_CHARS  # noqa: E402
