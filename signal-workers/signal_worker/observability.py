...
WRITE_DURATION = Histogram(
    "signal_worker_write_duration_seconds",
...
def set_ready(value: bool) -> None:
    """Signal readiness state. Called once by run_poll() after the loop starts."""
    global _ready
    with _ready_lock:
        _ready = value
